...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Asus\PycharmProjects\cvs_pandas_mysql'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Asus\PycharmProjects\cvs_pandas_mysql\Scripts\deactivate.nu'
